...
<div class="w-screen h-screen">
  <div
    class="absolute inset-0 bg-cover bg-center bg-repeat-y" style="background-image: url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fremoval.ai%2Fblue-background-images%2F&psig=AOvVaw176MXm4XFER4HghXN6IN9b&ust=1720354057289000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCIjll7WwkocDFQAAAAAdAAAAABAE');">
  </div>
  <div class="relative" id="relative">
    <header>
      <div class="sm:px-12 mx-auto flex items-center justify-center p-4 shadow-2xl bg-white bg-opacity-30">
        <div class="flex items-center space-x-2 justify-center">
          <button>
            <img src="../assets/image/logo.png" alt="Logo" class="w-10">
          </button>
        </div>
    </div>
    </header>
    ...
    <div class="container mx-auto top-0 right-0 my-60">
        <div>
                ...
                <div class="mt-16">
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-10 w-full flex flex-col items-center justify-center overflow-hidden text-sm">
                            ...
                            <a href="https://drive.google.com/file/d/1UC9ihEMRk6UbLUhcrbW-1z7LtQwypUJ7/view?usp=sharing" target="_blank" 
                                class="bg-gradient-to-r from-blue-400 to-blue-700 mr-2 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded mb-4"
                                download="Rivera, Noelito.pdf">
                                Download CV
                            </a>
