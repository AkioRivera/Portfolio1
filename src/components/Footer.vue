<template>
    <!--Footer container-->
<footer
  class="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white" id="contact">
  <div class="container px-6 pt-6">
    <!-- Social media icons container -->
    <div class="mb-6 flex justify-center space-x-2">
      <a
        href="https://www.facebook.com/Akiiooooo"
        type="button"
        ...
        <a
        href="mailto:noelitorivera1@gmail.com"
      ...
      <a
        href="https://www.linkedin.com/in/rivera-noelito-l-12a072314"
        target="_blank"
      ...
      <a
        href="https://github.com/Noelito-source/Capstone.git"
        type="button"
  ...
  <div class="w-full bg-black/5 p-4 text-center">
    © 2024 
    <a href="https://tw-elements.com/">Rivera Noelito -<span class="ml-2 self-center">noelitorivera1@gmail.com</span> - Vue</a>
  </div>
</footer>
</template>